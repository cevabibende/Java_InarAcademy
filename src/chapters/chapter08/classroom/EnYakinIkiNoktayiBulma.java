...
public class EnYakinIkiNoktayiBulma {
    public static void main(String[] args) {
        ...
        System.out.println("kaç nokta gireceksiniz");
        ...
        System.out.println("birbirine en yakın iki nokta " + noktalar[p1][0] + " , " + noktalar[p1][1] + " ile " + noktalar[p2][0] + " " + noktalar[p2][1] + " dır");

    }

    private static double mesafeHesapla(double x1, double x2, double y1, double y2) {
