...
public class Ex08 {
    ...
    private static void displayClosestTwoPoints(double[][] points) {
    ...
    private static void displayClosestPairs(double[][] points, double shortestPoint) {
        int p1;
        int p2;
        for (int i = 0; i < points.length; i++) {
    ...
    private static double[][] takepointsFromUser() {
